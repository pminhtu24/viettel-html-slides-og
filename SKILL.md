...
description: Generate HTML slides following the Viettel slide theme from JSON data. Supports 11 modular layouts.
---
...
- Support for **11 modular layouts**:
...
2. Select the most suitable built-in layout.
...
For a deck, create one JSON file and one HTML output per slide unless the user provides a deck wrapper requirement.
...
```json
{
  "layout": "timeline",
  "events": [
    { "date": "Q1 2026", "title": "Planning", "copy": "Defined scope and goals." },
    { "date": "Q2 2026", "title": "Alpha", "copy": "Initial prototype release." }
  ]
}
```
...
```json
{
  ...
  "items": [
    { "icon_svg": "<svg>...</svg>", "title": "Speed", "copy": "Extremely fast." },
    { "icon_svg": "<svg>...</svg>", "title": "Secure", "copy": "End-to-end encryption." }
  ]
}
```
